...
*/
    ...
    public void setPrice(double price) {
        if(price >= 0){
            ...
            System.out.println("Price should be non negative.");
        }
    ...
    public void setName(String name){
        if(name.length() > 2 && name.length() < 15){
            ...
            System.out.println("Name should be between 3 and 10 symbols.");
        }
    }
    ...
    public void setBrand(String brand){
        if(brand.length() > 2 && brand.length() < 10){
            ...
            System.out.println("Brand should be between 2 and 10 symbols.");
        }
    }
